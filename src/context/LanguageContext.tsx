...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "ssn_lookup_title": { en: "Start with your Social Security Number", fr: "Commencez par votre numéro de sécurité sociale" },
  "ssn_lookup_subtitle": { en: "We'll check if you already have a record with us and pre-fill your details. It only takes a second.", fr: "Nous vérifions si vous avez déjà un dossier et pré-remplissons vos informations. Cela ne prend qu'une seconde." },
  "ssn_lookup_search": { en: "Check", fr: "Vérifier" },
  "ssn_lookup_no_ssn": { en: "I don't have a Social Security Number yet", fr: "Je n'ai pas encore de numéro de sécurité sociale" },
  "ssn_found_title": { en: "Record found — details pre-filled", fr: "Dossier trouvé — informations pré-remplies" },
  "ssn_found_desc": { en: "We found your existing record. Please review each field below and correct anything that has changed.", fr: "Nous avons trouvé votre dossier. Vérifiez chaque champ ci-dessous et corrigez si nécessaire." },
  "ssn_new_title": { en: "New hire — let's set up your profile", fr: "Nouvelle embauche — créons votre profil" },
  "ssn_new_desc": { en: "No existing record found. Please complete your details below.", fr: "Aucun dossier existant. Merci de compléter vos informations ci-dessous." },
  "ssn_format_hint": { en: "15 digits, as shown on your Carte Vitale", fr: "15 chiffres, comme sur votre carte Vitale" },
  "ssn_have_question": { en: "Do you have a French Social Security Number (NIR)?", fr: "Avez-vous un numéro de sécurité sociale français (NIR) ?" },
  "ssn_have_yes_hint": { en: "We'll look it up and pre-fill your details", fr: "Nous le recherchons et pré-remplissons vos informations" },
  "ssn_have_no_hint": { en: "Continue as a new hire and fill the form", fr: "Continuer en tant que nouvelle recrue et remplir le formulaire" },
  "change": { en: "Change", fr: "Modifier" },
